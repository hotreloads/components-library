const FeatureThree = (): JSX.Element => {
    return (
        <section id="feature" className="mx-auto container py-20 ">
                ...
                <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center xl:gap-y-16 gap-y-20 gap-x-16 lg:gap-x-20 xl:gap-x-0 lg:px-10 xl:px-0">
                    <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                        ...
                        <div className=" mt-2 text-lg text-center ">
                            <p>
                                Workflows can help streamline and automate
                    ...
                    <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                        ...
                        <div className=" mt-2 text-lg text-center">
                            <p>
                                A flexible software architecture is able to
                                changes in usability requirements
                            </p>
                        </div>
                    </div>
                    <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                        ...
                        <div className="  mt-2 text-lg text-center">
                            <p>
                                Good usability can improve a new software
                    ...
                    <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                        ...
                        <div className="  mt-2 text-lg text-center">
                            <p>
                                Component-based design makes front-end web
                                development faster.
                            </p>
                        </div>
                    </div>
                    <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                        ...
                        <div className="  mt-2 text-lg text-center">
                            <p>
                                No more running around looking for things.When
                                you write things and plan.
                            </p>
                        </div>
                    </div>
                </div>
