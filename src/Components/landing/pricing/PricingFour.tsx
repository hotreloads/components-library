function PricingFour(): JSX.Element {
    return (
        <section id="pricing" className="py-10  sm:py-16 lg:py-24">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="hidden mt-16 lg:block">
                    <table className="w-full">
                        <thead>
                            <tr>
                                ...
                                <th className="px-4 py-8 text-center bg-gray-900 rounded-t-xl">
                                    <span className="px-4 py-2  font-medium text-white bg-blue-600 rounded-full">
                                        Popular
                                    </span>
                        ...
                        <tbody>
                            <tr>
                                <td className="py-4 pr-4 font-medium border-b ">
                                    Website number
                                </td>
                            ...
                            <tr>
                                ...
                                <td className="px-4 py-6 text-center">
                                    <a
                                        href="#"
                                        title=""
                                        className="inline-flex items-center font-semibold text-primary hover:text-blue-700">
                                        Get Started
                                        <svg
            ...
            <div className="block mt-12 border-t border-b  divide-y divide-gray-200 lg:hidden">
