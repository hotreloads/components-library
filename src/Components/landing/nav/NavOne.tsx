				...
				<div className="container mx-auto px-4">
					<div className="flex items-center justify-between py-4">
						...
						<div className="hidden sm:flex sm:items-center">
							<a href="#" className="text-sm font-semibold hover:text-primary mr-4">
								Products
							</a>
							<a href="#" className=" text-sm font-semibold hover:text-primary mr-4">
								Marketplace
							...
							<a href="#" className=" text-sm font-semibold hover:text-primary">
								Pricing
							</a>
						</div>
						<div className="hidden sm:flex sm:items-center">
							<a
								href="/login"
								className=" text-sm font-semibold hover:text-primary mr-4"
							>
								Sign in
							</a>
							<a
								href="/register"
								className=" text-sm font-semibold border px-4 py-2 rounded-lg hover:text-primary hover:border-primary"
							>
								Sign up
							</a>
						</div>
					...
					<div
						className={`${
							isOpen ? "block" : "hidden"
						} sm:hidden border-t-2 py-2 text-center`}
					>
						<div className="flex flex-col">
							<a href="#" className=" text-sm font-semibold hover:text-primary mb-2">
								Products
							</a>
							<a href="#" className="text-sm font-semibold hover:text-primary mb-2">
								Marketplace
							...
							<a
								href="#feature"
								className=" text-sm font-semibold hover:text-primary mb-2"
							>
								Features
							</a>
							<a
							...
							<a
								href="/register"
								className="text-sm font-semibold hover:text-primary pb-2 border-b-2"
							>
								Sign up
							</a>
						</div>
